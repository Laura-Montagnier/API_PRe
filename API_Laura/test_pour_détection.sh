...
model_path = './../Modèles/GB_model_pe_feats_détection.pkl'
...
# Chemin complet vers le modèle .pkl
model_path = './../Modèles/GB_model_ember_détection.pkl'
...
model_path='./../Modèles/grayscale_model_détection.h5'
...
model_path='./../Modèles/couleur_model_détection.h5'

Labels = ['Malware','Cleanware']
